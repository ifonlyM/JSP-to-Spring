...
<body>
    ...
    <main class="contract">
    	<h2>회원가입 약관 동의</h2>
        <textarea readonly="readonly" cols="80" rows="20">제 1 장 총 칙

 

제 1 조 (목적)
이 약관은 {MainStream!}(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
(시행일) 이 약관은 2021년 09월부터 시행합니다.</textarea>
        <div class="check"><label><input type="checkbox" checked >위 약관에 대해 확인하고 동의</label></div>
        <div class="signinbox"><a class="linkButton" href="join">회원가입</a></div>
